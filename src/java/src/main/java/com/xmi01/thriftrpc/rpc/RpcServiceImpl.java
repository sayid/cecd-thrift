...
public class RpcServiceImpl implements RpcService.Iface {
    ...
    public ResponseData callRpc(String classname, String method, String arglist, String extra) {
        ...
        Object argsObj1[] = null;
        try {
            //argsObj = objectMapper.readValue(arglist, ArrayList.class);
            argsObj1 = objectMapper.readValue(arglist, Object[].class);
        ...
        if (null != interceptor) {
             ...
             */
            Object beforeData;
            beforeData = interceptor.before(classname, method, argsObj1, extraObj);
            ...
            for (int index = 0; index < parameterTypes.size(); index++) {
                ...
                if (type.equals("String")) {
                    ...
                    if (type.contains(".")) {
                        ...
                        String oldArg = objectMapper.writeValueAsString(argsObj1[index]);
                        argsObj1[index] = objectMapper.readValue(oldArg, argsTypes[index]);
                ...
                //argsObj1[index] = argsObj.get(index);
        ...
        if (responseData.getCode() == 0) {
            ...
            if (responseData.getCode() == 0) {
                ...
                if (responseData.getCode() == 0) {
                    Object data = null;
                    try {
                        data = m.invoke(rpcServiceInterface, argsObj1);
